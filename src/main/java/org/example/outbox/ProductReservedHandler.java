...
@ApplicationScoped
public class ProductReservedHandler implements EventHandler {

    @Inject ProductService productService;
    @Inject ProductProducer productProducer;
    ...
    public void compensate(Event payload) {
        productService.releaseProducts((List<ReserveProductDTO>) payload);
    }
}
